...
/*   Updated: 2023/08/27 17:36:35 by mapfenni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ra(t_list ***lst)
{
	if (!lst[0][0] || ft_lstsize(lst[0][0]) == 0 || ft_lstsize(lst[0][0]) == 1)
		return ;
	ft_lstadd_back(lst[0], ft_lstnew_int(lst[0][0]->content, lst[0][0]->neg));
...
void	rb(t_list ***lst)
{
	if (!lst[1][0] || ft_lstsize(lst[1][0]) == 0 || ft_lstsize(lst[1][0]) == 1)
		return ;
	ft_lstadd_back(lst[1], ft_lstnew_int(lst[1][0]->content, lst[1][0]->neg));
